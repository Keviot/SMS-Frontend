...
export default function AuthLayout({ children, title, illustration = sms, tagline }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen bg-white font-sans selection:bg-orange-100">
        ...
        <div className="max-w-2xl w-full flex flex-col items-center">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center gap-2 mt-6">
              <div className="h-2 w-8 rounded-full bg-[#EE641D]"></div>
              <div className="h-2 w-4 rounded-full bg-[#EE641D]/30"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative overflow-hidden bg-[#fdfdfd]">
        ...
        <div className="w-full max-w-[630px] min-h-[501px] h-auto bg-white rounded-3xl p-6 lg:p-10 shadow-[0_10px_50px_-12px_rgba(0,0,0,0.1)] border border-gray-100 relative z-10 backdrop-blur-sm bg-white/95 flex flex-col justify-center overflow-y-auto">
